...
Understanding:
brillian.org (wiki/fibonacci_heap)
wikipedia.com - fibonacci heap
geeksforgeeks.com - they explained the implementation with steps

Implementation:
github.com - found some implementations in C++
cs.pricenton - found a pdf that explained the inner workings
